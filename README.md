...
We need to deploy in order to consume the private/public testing endpoints.
...
If everything was set up correctly, all incoming requests to your `someFunction` Lambda will first be authorized. 
